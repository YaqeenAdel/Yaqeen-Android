...
class GetLocalMedicalAppointmentUseCase @Inject constructor(private val repository: IScheduleRepository) {
    suspend operator fun invoke(
        medicalAppointmentId: Int
    ): Flow<DataState<MedicalAppointmentDB?>> =
        repository.getMedicalAppointment(
